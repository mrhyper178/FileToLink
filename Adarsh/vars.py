...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(getenv('API_ID', '8733404'))
    API_HASH = str(getenv('API_HASH', 'f19aed00b0c74abed0359016afc1733f'))
    BOT_TOKEN = str(getenv('BOT_TOKEN', '6889769531:AAFvaNtue9alNTcu2TNHMao7Z_z0ZLNz1HY'))
    name = str(getenv('name', 'QL_File2Link_Bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002117688872'))
